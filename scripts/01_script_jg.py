...
processor = Wav2Vec2Processor.from_pretrained("jonatasgrosman/wav2vec2-large-xlsr-53-german")
model = Wav2Vec2ForCTC.from_pretrained("jonatasgrosman/wav2vec2-large-xlsr-53-german")

###import IPython.display as display
###display.Audio("sample_clip1.mp3", autoplay=True )

#load any audio file with 16KHZ sampling rate
speech, rate = librosa.load("test_audio_1.wav",sr=16_000)
